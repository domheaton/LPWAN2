...
const firebaseNewData = firebaseRef.child('payload_raw');

//Retrieve data from the database
firebaseNewData.on('value', function(snapshot) {
    console.log(snapshot.val());
    chart.data.datasets[0].data.push(snapshot.val()['0']);
    chart.data.datasets[1].data.push(snapshot.val()['1']);
    chart2.data.datasets[0].data.push(snapshot.val()['2']);
    chart.update();
    chart2.update();
});
